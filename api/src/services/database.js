    ...
    if (query.includes('INSERT OR IGNORE INTO users')) {
      ...
      if (!existing) {
        this.users.set(String(tgId), {
          ...
          referral_balance_store: 0,
          referral_balance_cash: 0,
          referral_withdrawn_total: 0,
          referral_last_withdraw_request_at: '',
          first_paid_order_at: '',
          fortune_date: '',
          fortune_used: 0,
      ...
      this.users.set(tgId, {
        ...
        referral_balance_store: Number(prev?.referral_balance_store || 0),
        referral_balance_cash: Number(prev?.referral_balance_cash || 0),
        referral_withdrawn_total: Number(prev?.referral_withdrawn_total || 0),
        referral_last_withdraw_request_at: String(prev?.referral_last_withdraw_request_at || ''),
